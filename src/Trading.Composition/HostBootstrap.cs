...
public static class HostBootstrap
{
    public static IHost Build(string[] args, Action<IHostApplicationBuilder>? configure = null)
    {
        ...
        builder.Services.TryAddSingleton<ProductionOperatorAuthorization>();
        builder.Services.TryAddSingleton<IOperatorAuthorization>(x => x.GetRequiredService<ProductionOperatorAuthorization>());
        builder.Services.TryAddSingleton<ProductionOperatorWorkflowPort>();
        builder.Services.TryAddSingleton<IOperatorWorkflowPort>(x => x.GetRequiredService<ProductionOperatorWorkflowPort>());
        builder.Services.TryAddSingleton<AuthorizedOperatorService>();
        builder.Services.TryAddSingleton<IOperatorQueries>(x => x.GetRequiredService<AuthorizedOperatorService>());
        builder.Services.TryAddSingleton<IBotOperatorService>(x => x.GetRequiredService<AuthorizedOperatorService>());
        builder.Services.TryAddSingleton<IRunOperatorService>(x => x.GetRequiredService<AuthorizedOperatorService>());
        builder.Services.TryAddSingleton<IResearchOperatorService>(x => x.GetRequiredService<AuthorizedOperatorService>());
        builder.Services.TryAddSingleton<IProposalOperatorService>(x => x.GetRequiredService<AuthorizedOperatorService>());
        builder.Services.TryAddSingleton<IKillSwitchOperatorService>(x => x.GetRequiredService<AuthorizedOperatorService>());
        builder.Services.TryAddSingleton(ProductionOperatorAuthorization.CreatePrincipal(options));
