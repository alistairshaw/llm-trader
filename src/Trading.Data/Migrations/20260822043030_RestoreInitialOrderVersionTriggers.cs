...
/// <inheritdoc />
public partial class RestoreInitialOrderVersionTriggers : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql("CREATE TRIGGER orders_version_monotonic_update BEFORE UPDATE ON orders WHEN NEW.version <> OLD.version + 1 BEGIN SELECT RAISE(ABORT, 'order version must advance by one'); END;");
    }
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql("DROP TRIGGER IF EXISTS orders_version_monotonic_update;");
    }
}
