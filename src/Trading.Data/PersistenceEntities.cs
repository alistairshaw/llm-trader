...
internal sealed class GuardrailEvaluationEntity : PersistenceEntity { public string TradeProposalId { get; set; } = string.Empty; public int EvaluationSequence { get; set; } public string EvaluationStage { get; set; } = string.Empty; public string PolicyVersion { get; set; } = string.Empty; public string Outcome { get; set; } = string.Empty; public string StateSnapshotId { get; set; } = string.Empty; public string RuleResultsJson { get; set; } = string.Empty; public long EvaluatedAt { get; set; } }
