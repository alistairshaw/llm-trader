...
{
    private static readonly string[] ExpectedRouteTitles =
        ["Bots", "Portfolios", "Runs", "Research", "Proposals", "Execution", "Risk", "Settings"];

    [Test]
    public void RoutesCoverEachStageSevenFeatureAreaWithStableUniqueMetadata()
    {
    ...
    [Test]
    public async Task NavigationPublishesOneActiveRouteAndDisposesThePreviousPage()
    {
    ...
    [Test]
    public async Task NewNavigationCancelsObsoleteLoadingAndReleasesItsPage()
    {
    ...
    [Test]
    public async Task LoadFailureIsDeterministicAndPreservesTheCurrentPage()
    {
