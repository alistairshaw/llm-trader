...
public sealed class Stage1FoundationSteps(Stage1ScenarioState state, Stage2PersistenceDriver stage2, Stage3RuntimeDriver stage3)
{
    ...
    private static TradeProposal NewProposal() => new(TradeProposalId.New(), TradingBotId.New(), BotRunId.New(), PortfolioId.New(), TradingBotConfigurationVersionId.New(), PortfolioDecisionSnapshotId.New(), InstrumentId.New(), new DirectTradeAction(TradeSide.Buy, new Quantity(10, "shares"), "Limit", new Price(25, Currency.USD), "Day"), "rationale", new ProposalContentVersion(1, "proposal-hash"), new HypothesisEvidenceReference(HypothesisVersionId.New(), "hypothesis-hash"), [new ReportEvidenceReference(ResearchReportId.New(), "series", 1, "report-hash")], Now, Now.AddHours(1));
