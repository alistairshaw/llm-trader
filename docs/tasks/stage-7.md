...
[`S7-003`](stage-7/S7-003-operational-kill-switches.md) is ready. `S7-004` is also ready and may run in parallel.
...
| [`S7-004`](stage-7/S7-004-wpf-host-lifecycle.md) | Compose WPF with the Generic Host | Ready | 920 | `S7-002` |
...
| [`S7-017`](stage-7/S7-017-wpf-critical-journeys.md) | Automate critical WPF operator journeys | Planned | 740 | `S7-015`, `S7-016` |
