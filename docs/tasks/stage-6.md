...
[`S6-014`](stage-6/S6-014-headless-paper-demo.md) is the next ready task.
...
| [`S6-014`](stage-6/S6-014-headless-paper-demo.md) | Demonstrate the complete paper workflow in the headless host | Ready | 720 | `S6-012`, `S6-013` |
